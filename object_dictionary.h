...
inline std::string objectDictionaryCSV(const ObjectDictionary &obj) {
    ...
    ss  << obj.gyro_x << "," << obj.gyro_y << "," << obj.gyro_z << ","
        ...
        << obj.gimbal_x << "," << obj.gimbal_x_current << "," << obj.position_gimbal_x << "," << obj.gimbal_y << "," << obj.gimbal_y_current << "," << obj.position_gimbal_y << ","
        ...
        << obj.main_ETH << "," << obj.current_ETH_main_valve << "," << obj.position_ETH_main_valve << "," << obj.main_N2O << "," << obj.current_N2O_main_valve << "," << obj.position_N2O_main_valve << ","
        << obj.sol_ETH << "," << obj.sol_N2O << ","
        << obj.igniter << ","
        << obj.sequence_finished << ","
        ...
        << obj.cmd_idle << "," << obj.cmd_arm << "," << obj.cmd_launch << ","
        << obj.cmd_abort << "," << obj.cmd_tare_orientation << "," << obj.cmd_tare_pressures << ","
        << obj.hopper_state;
    return ss.str();
}
