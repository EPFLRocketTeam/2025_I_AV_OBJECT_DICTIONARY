...
inline std::string objectDictionaryCSV(const ObjectDictionary &obj) {
    ...
    ss  << fixed16_to_float(obj.gyro_x) << "," << fixed16_to_float(obj.gyro_y) << "," << fixed16_to_float(obj.gyro_z) << ","
        ...
        << (int)obj.main_ETH << "," << fixed16_to_float(obj.current_ETH_main_valve) << "," << fixed16_to_float(obj.position_ETH_main_valve) << "," 
        << (int)obj.main_N2O << "," << fixed16_to_float(obj.current_N2O_main_valve) << "," << fixed16_to_float(obj.position_N2O_main_valve) << ","
        << (bool)obj.sol_ETH << "," << (bool)obj.sol_N2O << ","
        << (bool)obj.igniter << "," << (bool)obj.sequence_finished << ","
        ...
        << (bool)obj.cmd_idle << "," << (bool)obj.cmd_arm << "," << (bool)obj.cmd_launch << "," << (bool)obj.cmd_abort << ","
        << (bool)obj.cmd_tare_orientation << "," << (bool)obj.cmd_tare_pressures << ","
